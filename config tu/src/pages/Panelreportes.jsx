 ...
 * PROPOSITO: Componente de página que muestra un panel de reportes y
 *            estadísticas de inventario para el administrador. Presenta
 *            un gráfico de barras con el stock de materiales, estadísticas
 *            resumidas (total de materiales, stock total, materiales sin
 *            stock), un filtro por categoría y una tabla detallada del
 *            inventario con el estado de cada material. Utiliza la librería
...
/* Importación del módulo de API centralizado para llamadas HTTP */
import { api } from '../api';
...
function PanelReportes() {
    ...
    /* useEffect con dependencias vacías: se ejecuta una sola vez al montar.
       Carga el nombre de sesión del admin, los insumos y las categorías. */
    useEffect(() => {
